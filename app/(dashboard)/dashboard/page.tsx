...
function ConnectionsSkeleton() {
  return (
    <div className="border border-[#E8E8E8] rounded overflow-hidden animate-pulse">
      {[1, 2, 3].map((i) => (
        <div key={i} className={`flex items-center gap-4 px-5 py-[18px] ${i < 3 ? "border-b border-[#E8E8E8]" : ""}`}>
    ...
    return (
      <div className="mx-auto max-w-2xl">
        <div className="rounded border border-[#CC2A1E]/20 bg-red-50 p-8">
          <h2 className="text-xl font-bold text-[#CC2A1E]">Database not ready</h2>
