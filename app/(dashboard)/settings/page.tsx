...
function SettingsSkeleton() {
  return (
    <div className="space-y-6 animate-pulse">
      <div className="border border-[#E8E8E8] rounded p-6">
        <div className="h-3 w-16 rounded bg-[#F4F4F4] mb-5" />
        <div className="space-y-5">
          <div>
            <div className="h-4 w-24 rounded bg-[#E8E8E8] mb-2" />
            <div className="h-10 rounded border border-[#DEDEDE] bg-[#F6F6F6]" />
          </div>
          <div>
            <div className="h-4 w-12 rounded bg-[#E8E8E8] mb-2" />
            <div className="h-10 rounded border border-[#DEDEDE] bg-[#F6F6F6]" />
          </div>
        </div>
      </div>
